...
public class IdentifyFaceDetectActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_identify_face_detect);
        init();
    }
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.qc_save) {
            ...
            PWTextUtils.showDescribeText(linerreCognizeThrehold, tvThreshold,
                    IdentifyFaceDetectActivity.this,
                    getString(R.string.cw_recognizethrehold), showWidth, showXLocation);
        }
    }
