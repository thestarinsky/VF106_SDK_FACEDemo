    ...
    public void init() {
        ...
        minFace.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PWTextUtils.showDescribeText(minRepresent, minFaceText, IdentifyMinFaceActivity.this,
        ...
        minFaceThreshold.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PWTextUtils.showDescribeText(faceThreshold, minFaceThreshold, IdentifyMinFaceActivity.this,
