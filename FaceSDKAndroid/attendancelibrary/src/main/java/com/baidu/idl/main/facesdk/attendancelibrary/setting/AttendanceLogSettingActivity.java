...
public class AttendanceLogSettingActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attendance_log_setting);
        init();
        initListener();
    }
    private void init(){
    ...
    private void initListener(){
        tipsLog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PWTextUtils.showDescribeText(groupFunLog, tvLog, AttendanceLogSettingActivity.this,
