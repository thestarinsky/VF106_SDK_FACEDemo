...
public class AttendanceConfigQualtifyActivity extends BaseActivity {
    ...
    public void setClickListener() {
        ...
        cwGesture.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PWTextUtils.showDescribeText(linerGesture, tvGesture, AttendanceConfigQualtifyActivity.this,
        ...
        cwIlluminiation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PWTextUtils.showDescribeText(linerIlluminiation, tvIlluminiation, AttendanceConfigQualtifyActivity.this,
        ...
        cwBlur.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PWTextUtils.showDescribeText(linerBlur, tvBlur, AttendanceConfigQualtifyActivity.this,
        ...
        cwocclusion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PWTextUtils.showDescribeText(linerocclusion, tvocclusion, AttendanceConfigQualtifyActivity.this,
