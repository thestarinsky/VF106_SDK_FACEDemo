...
//            SingleBaseConfig.getBaseConfig().setThreshold(jsonObject.getInt("threshold"));
            ...
            SingleBaseConfig.getBaseConfig().setCpuUp(jsonObject.getInt("cpuUp"));
...
//            int radius = (int) jsonObject.get("radius");
            ...
            int rgbAndNirScoreThreshold = Integer.valueOf(jsonObject.get("rgbAndNirScoreThreshold") + "");
            if (rgbAndNirScoreThreshold < 0 || rgbAndNirScoreThreshold > 100) {
                return false;
            }
            ...
            int liveScoreThreshold = Integer.valueOf(jsonObject.get("liveScoreThreshold") + "");
            if (liveScoreThreshold < 0 || liveScoreThreshold > 100) {
                return false;
            }

            int idScoreThreshold = Integer.valueOf(jsonObject.get("idScoreThreshold") + "");
...
//            jsonObject.put("threshold", SingleBaseConfig.getBaseConfig().getThreshold());
            ...
            jsonObject.put("cpuUp", SingleBaseConfig.getBaseConfig().getCpuUp());
