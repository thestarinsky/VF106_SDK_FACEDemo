...
public class FinanceMinFaceActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_finance_minface);
    ...
    public void init() {
        ...
        minFace.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PWTextUtils.showDescribeText(minRepresent, minFaceText, FinanceMinFaceActivity.this,
        ...
        minFaceThreshold.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PWTextUtils.showDescribeText(faceThreshold, minFaceThreshold, FinanceMinFaceActivity.this,
