...
public class FaceLivinessTypeActivity extends BaseActivity implements View.OnClickListener {
    ...
    private LinearLayout detectionFrameNumberLl;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_finance_facelivinesstype);
        init();
    }
    ...
    public void init() {
        ...
        detectionFrameNumberLl = findViewById(R.id.detection_frame_number_Ll);
...
//                    detectionFrameNumberLl.setVisibility(View.VISIBLE);
//                } else {
//                    qcLiving.setChecked(false);
//                    qc_linerLiving.setVisibility(View.INVISIBLE);
//                    detectionFrameNumberLl.setVisibility(View.INVISIBLE);
//                    liveTypeValue = zero;
//                    justify();
//                }
//            }
...
//        }
        ...
        Log.i("wangshu", "framesThreshold：" + framesThreshold);
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.fls_save) {
            ...
            startActivity(new Intent(FaceLivinessTypeActivity.this, FinanceLensSelectionActivity.class));
