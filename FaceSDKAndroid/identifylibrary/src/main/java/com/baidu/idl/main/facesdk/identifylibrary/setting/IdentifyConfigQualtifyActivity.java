...
public class IdentifyConfigQualtifyActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_identify_config_qualtify);
    ...
    public void setClickListener() {
        ...
        cwGesture.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PWTextUtils.showDescribeText(linerGesture, tvGesture, IdentifyConfigQualtifyActivity.this,
        ...
        cwIlluminiation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PWTextUtils.showDescribeText(linerIlluminiation, tvIlluminiation, IdentifyConfigQualtifyActivity.this,
        ...
        cwBlur.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PWTextUtils.showDescribeText(linerBlur, tvBlur, IdentifyConfigQualtifyActivity.this,
        ...
        cwocclusion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PWTextUtils.showDescribeText(linerocclusion, tvocclusion, IdentifyConfigQualtifyActivity.this,
