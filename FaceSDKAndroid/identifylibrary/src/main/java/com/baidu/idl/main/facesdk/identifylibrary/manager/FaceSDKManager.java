    ...
    public void onDetectCheck(final byte[] rgbData,
        ...
        future = es.submit(new Runnable() {
            ...
            public void run() {
                ...
                Log.e("getType","" + SingleBaseConfig.getBaseConfig().getType());
                Log.e("getCameraType","" + SingleBaseConfig.getBaseConfig().getCameraType());
                Log.e("getRgbDetectDirection","" + SingleBaseConfig.getBaseConfig().getRgbDetectDirection());
                Log.e("getMirrorDetectRGB","" + SingleBaseConfig.getBaseConfig().getMirrorDetectRGB());
    ...
    public void onLivenessCheck(final BDFaceImageInstance rgbInstance,
        ...
        future2 = es2.submit(new Runnable() {
            ...
            public void run() {
                ...
                Log.e("isQualityControl","" + SingleBaseConfig.getBaseConfig().isQualityControl());
                Log.e("isAttribute","" + SingleBaseConfig.getBaseConfig().isAttribute());
                Log.e("isBestImage","" + SingleBaseConfig.getBaseConfig().isBestImage());
                ...
                Log.e("getActiveModel","" + SingleBaseConfig.getBaseConfig().getActiveModel());
                Log.e("getCameraLightThreshold","" + SingleBaseConfig.getBaseConfig().getCameraLightThreshold());
...
//                    LogUtils.e(TIME_TAG, "live rgb time = " + livenessModel.getRgbLivenessDuration());
                ...
                if (liveCheckMode == 2 || liveCheckMode == 4 && nirData != null) {
                    ...
                    // TODO: 用户调整旋转角度和是否镜像，手机和开发版需要动态适配
                    Log.e("getNirDetectDirection","" + SingleBaseConfig.getBaseConfig().getNirDetectDirection());
                    Log.e("getMirrorDetectNIR","" + SingleBaseConfig.getBaseConfig().getMirrorDetectNIR());
...
//                        LogUtils.e(TIME_TAG, "live ir time = " + livenessModel.getIrLivenessDuration());
                ...
                if (liveCheckMode == 3 || liveCheckMode == 4 && depthData != null) {
                    ...
                    if (SingleBaseConfig.getBaseConfig().getCameraType() == 1) {
                        ...
                        Log.e("getDepthWidth","" + SingleBaseConfig.getBaseConfig().getDepthWidth());
                        Log.e("getDepthHeight","" + SingleBaseConfig.getBaseConfig().getDepthHeight());
