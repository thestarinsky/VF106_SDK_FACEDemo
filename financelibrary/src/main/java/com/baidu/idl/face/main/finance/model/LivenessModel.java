...
public class LivenessModel {
    ...
    private long qualityDetectDuration;
    ...
    private List<String> listOcclusion;
    private List<String> listDetected;

    public List<String> getListOcclusion() {
        return listOcclusion;
    }

    public void setListOcclusion(List<String> listOcclusion) {
        this.listOcclusion = listOcclusion;
    }

    public List<String> getListDetected() {
        return listDetected;
    }

    public void setListDetected(List<String> listDetected) {
        this.listDetected = listDetected;
    }

    public long getQualityDetectDuration() {
        return qualityDetectDuration;
    }

    public void setQualityDetectDuration(long qualityDetectDuration) {
        this.qualityDetectDuration = qualityDetectDuration;
    }
