...
public class FinanceConfigQualtifyActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_finance_config_qualtify);
    ...
    public void setClickListener() {
        ...
        cwGesture.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PWTextUtils.showDescribeText(linerGesture, tvGesture, FinanceConfigQualtifyActivity.this,
        ...
        cwIlluminiation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PWTextUtils.showDescribeText(linerIlluminiation, tvIlluminiation, FinanceConfigQualtifyActivity.this,
        ...
        cwBlur.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PWTextUtils.showDescribeText(linerBlur, tvBlur, FinanceConfigQualtifyActivity.this,
        ...
        cwocclusion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PWTextUtils.showDescribeText(linerocclusion, tvocclusion, FinanceConfigQualtifyActivity.this,
